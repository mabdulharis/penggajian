         ...
         <nav class="navbar fixed-top">
            <div class="container-fluid nav-logo">
               <div class="d-flex align-items-center justify-content-center">
                  <img src="<?php echo base_url(); ?>assets/img/kopti.jpg" alt="Logo" width="100" height="50">
                  <a class="navbar-brand pl-5" href="#">Gaji Karyawan</a>
               </div>
               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selamat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>KOPTI Kabupaten Bogor</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan KOPTI Kabupaten Bogor</div>
            </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/kopti.jpg" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">PENGGAJIAN KARYAWAN</div>
                           <div class="Job">KOPTI Kabupaten Bogor</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Kelompok 7 | Penggajian 2023 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
